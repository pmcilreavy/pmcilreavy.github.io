...
After a quick search on ServerFault it seems skype also supports a */username* switch that will pre-populate the username field with whatever value you give it. So we can do this...
